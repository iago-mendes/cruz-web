...
export default function Contact() {
	...
	return (
		<Container className="page">
			<SEOHead title="Contato | Cruz Representações" />

			<div className="scrollable">
				<form onSubmit={e => e.preventDefault()}>
					<h1>E-mail</h1>
					<p>
						Para entrar em contato conosco por e-mail, use o formulário abaixo
						ou envie um e-mail para{' '}
						<a href="mailto:contato@cruzrepresentacoes.com.br">
				...
				<div className="phones">
					<h1>Telefones</h1>
					<p>
						Para entrar em contato conosco por telefone, use algum dos números
						abaixo.
					</p>
